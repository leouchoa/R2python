...
**Important**: If you're creating a python library, you **must** specify the __init__ files because they are the reference to what's being imported. Otherwise when importing the lib, python won't find the modules you want.
...
- Python Packages [good overview](https://python-packaging-tutorial.readthedocs.io/en/latest/setup_py.html), a [video](https://www.youtube.com/watch?v=wCGsLqHOT2I) and a [simplified version](https://oneraynyday.github.io/dev/2017/08/02/Python-File-Structure/)
