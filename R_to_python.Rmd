...
In python receive an error message instead of a warning.
...
But broadcasting here allows us to do some cool things, like computing row/column-wise percentages. For example:
